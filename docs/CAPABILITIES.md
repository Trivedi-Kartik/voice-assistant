...
| "Add Photoshop as an app I can open" | **Always asks you out loud to confirm first.** Say "yes," and a file picker opens for you to browse to and select the actual program — you always pick the real file yourself, nothing is added automatically. Once added, you can say "open Photoshop" / "close Photoshop" just like any built-in app. Only added on this device, for you — manage or remove what you've added in Settings → "My apps." |
