    ...
    <div className="consent-screen">
      <div className="glass">
        ...
        <ul>
          ...
          <li>You can ask it to add your own apps to that list (e.g. "add Photoshop as an app I can open") — it always asks you to confirm first, and you always pick the actual program yourself in a file picker; nothing is ever added automatically.</li>
