  ...
  return (
    <div className="consent-screen">
      ...
      <ul>
        ...
        <li>This app can take real actions on your computer on your behalf — opening and closing apps, controlling media, setting reminders, running web searches, and opening URLs — only from a fixed, safe list your assistant is allowed to use. Actions that are risky (closing an app) or could expose something private (reading your clipboard, taking a screenshot) always ask you to confirm first.</li>
        <li>If you approve a screenshot, an image of your screen at that moment is sent to a cloud AI model to be described back to you — more sensitive than anything else this app shares, which is why it's never done without asking first.</li>
